let classifier;
let imageModelURL = 'https://teachablemachine.withgoogle.com/models/gDh4byWVF/'; 
let video;
...
function draw() {
  ...
  if (label === "Clase 1" && confidence > 0.85) {
    noFill();
  ...
  if (label === "Clase 1" && confidence > 0.95) {
...
function drawCartoonUI() {
  ...
  // Traducimos Clase 1 a nombre divertido
  let msg = (label === "Clase 1") ? "💥 ¡CARTOON DETECTADO! 💥" : "🔍 BUSCANDO DIBUJOS...";
